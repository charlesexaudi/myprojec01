...
<div class="sidebar" id="sidebar">
        ...
        <a href="#" >78HOME</a><br>
      <a href="#">ABOUT</a><br>
      <a href="#">E-LERNING</a><br>
      <a href="#">EVENT</a><br>
      <a href="#">MTC LIBRARY</a><br>
      <a href="#">ALMANAC</a><br>
      <a href="#">COURSE</a><br>
...
<p class="ppoint">3. We raise students and prepare them to solve problems in society</p>
   ...
   <div class="row row-cols-1 row-cols-xm-1 g-4">
  <div class="col">
 ...
 <div class="row row-cols-1 row-cols-xm-3 g-4">
  <div class="col">
    <div class="card h-100">
...
<br><br>
<div class="card xm-3" style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-xm-4">
  ...
  <section class="">
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <!-- Grid column -->
        <div class="col-xm-4 col-xm-3 col-xl-3 mx-auto xm-md-0 xm-4">
          <!-- Links -->
          <h6 class="text-uppercase fw-bold xm-4">Contact</h6>
